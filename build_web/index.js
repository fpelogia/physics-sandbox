...
// include: /var/folders/1j/gbv50pk57lx4v8b29kkzwlbc0000gn/T/tmp_geueuzh.js
...
Module['FS_createPath']("/", "resources", true, true);
    ...
    loadPackage({"files": [{"filename": "/resources/wabbit_alpha.png", "start": 0, "end": 496}], "remote_package_size": 496});

  })();

// end include: /var/folders/1j/gbv50pk57lx4v8b29kkzwlbc0000gn/T/tmp_geueuzh.js
...
var ASM_CONSTS = {
  96672: () => { if (document.fullscreenElement) return 1; },  
 96718: () => { return Module.canvas.width; },  
 96750: () => { return parseInt(Module.canvas.style.width); },  
 96798: () => { document.exitFullscreen(); },  
 96825: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 96898: () => { if (document.fullscreenElement) return 1; },  
 96944: () => { return Module.canvas.width; },  
 96976: () => { return screen.width; },  
 97001: () => { document.exitFullscreen(); },  
 97028: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97161: () => { return window.innerWidth; },  
 97187: () => { return window.innerHeight; },  
 97214: () => { if (document.fullscreenElement) return 1; },  
 97260: () => { return Module.canvas.width; },  
 97292: () => { return parseInt(Module.canvas.style.width); },  
 97340: () => { if (document.fullscreenElement) return 1; },  
 97386: () => { return Module.canvas.width; },  
 97418: () => { return screen.width; },  
 97443: () => { return window.innerWidth; },  
 97469: () => { return window.innerHeight; },  
 97496: () => { if (document.fullscreenElement) return 1; },  
 97542: () => { return Module.canvas.width; },  
 97574: () => { return screen.width; },  
 97599: () => { document.exitFullscreen(); },  
 97626: () => { if (document.fullscreenElement) return 1; },  
 97672: () => { return Module.canvas.width; },  
 97704: () => { return parseInt(Module.canvas.style.width); },  
 97752: () => { document.exitFullscreen(); },  
 97779: ($0) => { Module.canvas.style.opacity = $0; },  
 97817: () => { return screen.width; },  
 97842: () => { return screen.height; },  
 97868: () => { return window.screenX; },  
 97895: () => { return window.screenY; },  
 97922: () => { return window.devicePixelRatio; },  
 97958: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98011: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 98062: () => { Module.canvas.style.cursor = 'none'; },  
 98099: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 98355: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 98406: () => { if (document.pointerLockElement) return 1; },  
 98453: () => { if (document.fullscreenElement) return 1; },  
 98499: () => { return window.innerWidth; },  
 98525: () => { return window.innerHeight; }
};
